      ...
      <div className="relative px-7 py-3 z-10 md:px-16 mx-auto gap-6 flex justify-between items-center md:flex-row flex-col mt-6">
        ...
        <div className="flex flex-col gap-5 md:gap-6 ">
          ...
          <div>
            ...
            <button className="py-3 md:py-3 px-5 text-white bg-gradient-to-r w-full md:w-[130px] from-[#F0F8FB] via-[#28C6F3] to-[#28C6F3] rounded-4xl font-bold font-inter tracking-wide  text-[11px] ">
              Email
            </button>
          </div>
        </div>
